 ...
 */
    class TouchRecognizer_IOS : UIGestureRecognizer
    {
        ...
        static Dictionary<UIView, TouchRecognizer_IOS> viewDictionary =
            new Dictionary<UIView, TouchRecognizer_IOS>();

        static Dictionary<long, TouchRecognizer_IOS> idToTouchDictionary =
            new Dictionary<long, TouchRecognizer_IOS>();

        public TouchRecognizer_IOS(Element element, UIView view, TouchTracking.TouchEffect touchEffect)
        {
        ...
        void CheckForBoundaryHop(UITouch touch)
        {
            ...
            TouchRecognizer_IOS recognizerHit = null;
        ...
        void FireEvent(TouchRecognizer_IOS recognizer, long id, TouchActionType actionType, UITouch touch, bool isInContact)
        {

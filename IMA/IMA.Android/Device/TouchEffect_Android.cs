...
[assembly: ExportEffect(typeof(TouchTracking.Droid.TouchEffect_Android), "TouchEffect")]
...
namespace TouchTracking.Droid
{
  ...
  */
    public class TouchEffect_Android : PlatformEffect
    {
        ...
        static Dictionary<Android.Views.View, TouchEffect_Android> viewDictionary =
            new Dictionary<Android.Views.View, TouchEffect_Android>();

        static Dictionary<int, TouchEffect_Android> idToEffectDictionary =
            new Dictionary<int, TouchEffect_Android>();
        ...
        {
            TouchEffect_Android touchEffectHit = null;
        ...
        void FireEvent(TouchEffect_Android touchEffect, int id, TouchActionType actionType, Point pointerLocation, bool isInContact)
        {
